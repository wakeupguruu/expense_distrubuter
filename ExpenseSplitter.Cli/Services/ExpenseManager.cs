...
namespace ExpenseSplitter.Cli.Services;
...
public class ExpenseManager
{
        ...
        IEnumerable<Split> splits)
    {
        ...
        // Warning scenario: selected participant with zero amount handled by caller via confirmation.
        ...
        // Update balances
        payer.Balance -= amount; // payer paid => they are owed this amount
        foreach (var s in splitList)
        {
            s.Participant.Balance += s.Amount; // each participant owes their share
        }
